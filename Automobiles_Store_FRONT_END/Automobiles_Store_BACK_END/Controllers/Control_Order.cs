...
namespace Automobiles_Store_BACK_END.Controllers
{
    public class Control_Order
    {
        ...
        {
            this.clear();
            StreamReader file = new StreamReader(@"D:\1_PROGRAMARE\C#\PROIECTE\Automobiles_Store\Automobiles_Store_FRONT_END\Automobiles_Store_FRONT_END\bin\Debug\Resorces\Orders_File.txt");
            string line = "";
        ...
        public void save()
        {
            StreamWriter file = new StreamWriter(@"D:\1_PROGRAMARE\C#\PROIECTE\Automobiles_Store\Automobiles_Store_FRONT_END\Automobiles_Store_FRONT_END\bin\Debug\Resorces\Orders_File.txt");
